/* Klasse for hver enkelt tilgjengelige lærer, med navn,
 * spesialkompetanse, oppgaver etc.
 * Brukes for å lagre tilgjengelige ressurser for bruk i
 * fordelingsklassen.
 *
...
public class Laerer
{
	// Lærer som knyttes til kompetanse og oppgaver
	private String laererNavn;
	// Fagene lærerne har kompetanse i, maks 3
	private String[] spesialKompetanse = new String[3];
	// F.eks kontaktlærer, IKT-ansvarlig osv., maks 3
